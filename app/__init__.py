...
def make_app():
	...
	from app.handlers.admin import EventsAdminHandler, APIEventsHandler, APIEventStaffHandler, StaffAdminHandler, APIStaffHandler, TelemetryAdminHandler, TelemetryAdminDataHandler, APIEventWhitelistHandler
